...
if (process.platform === "win32") {
  // Print instruction for Windows; curl installer is bash-based
...
if (res.status !== 0) {
  console.warn("[hpcgpt] opencode install failed; you can install later via curl -fsSL https://opencode.ai/install | bash")
  process.exit(0)
}
